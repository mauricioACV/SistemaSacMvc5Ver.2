...
namespace SistemaSacMvcVer2.Infraestructura.Repositorios
{
    public class ReportesSacRepositorio : IReportesSacRepositorio
    {
        ...
        public List<ReportesSac> ObtenerListadoBasicoObrasPorEstadoYgrupo(ReportesSacFiltros filtroReporteBasico)
        {
            ...
            try
            {
                var query = @"select
                                ...
                                from CTO_CONTRATO
                                where
                                ( cto_contrato.estado_contrato = :pEstadoContrato ) and cto_contrato.grupo = :pGrupo
        ...
        public List<ReportesSac> ObtenerListadoBasicoObrasPorEstadoGrupoTipoContrato(ReportesSacFiltros filtroReporteBasico)
        {
            ...
            try
            {
                var query = @"select
                                ...
                                from CTO_CONTRATO
                                where
                                ( cto_contrato.estado_contrato = :pEstadoContrato ) and cto_contrato.grupo = :pGrupo and cto_contrato.tipo_contrato = :pTipoContrato
                                ORDER BY FECHA_TRAMITE";
        ...
        public List<ReportesSac> ObtenerListadoBasicoObrasPorEstadoGrupoSoloObras(ReportesSacFiltros filtroReporteBasico)
        {
            ...
            try
            {
                var query = @"select
                                ...
                                from CTO_CONTRATO
                                where
                                ( cto_contrato.estado_contrato = :pEstadoContrato ) and cto_contrato.grupo = :pGrupo and cto_contrato.tipo_contrato <> '00' and cto_contrato.tipo_contrato <> '01'
                                ORDER BY FECHA_TRAMITE";
